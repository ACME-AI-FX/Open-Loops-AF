<#
.SYNOPSIS  Register/remove the weekday 08:40 "Claude Open Loops Refresh" task.
.EXAMPLE   powershell -ExecutionPolicy Bypass -File scripts\register-task.ps1 [-At 08:40] [-Remove]
#>
[CmdletBinding()]
param([string]$TaskName = "Claude Open Loops Refresh", [string]$At = "08:40", [switch]$Remove)
